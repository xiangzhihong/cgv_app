import {TouchableOpacity, View, StyleSheet, Text, Animated, Easing,Image, Dimensions} from 'react-native'
            ...
            BUTTONS.map((item, index) => {
                ...
                return (
                    <View style={styles.buttonItem} key={index}>
                        <TouchableOpacity style={{justifyContent: 'center', alignItems: 'center'}} activeOpacity={0.7}
                                          onPress={() => onItemPress(item.type)}>
                            <Image source={item.icon}
                                   style={{width: itemWidth / 3, height: itemWidth / 3, marginBottom: 6}}/>

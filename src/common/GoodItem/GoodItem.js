...
const GoodItem = ({ item, type, where, addOrder, goBackRefresh, showTag, showPromotionText, showCountBtnsForced, canGoDetail = true }) => {
  ...
  <TouchableOpacity onPress={() => navigate('GoodDetailScreen', {
    ...
    <View style={styles.item}>
      <Image style={styles.goodPic} uri={item.smallImageUrl}/>

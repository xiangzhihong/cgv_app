...
const HeaderTitle = ({ title, titleView, titleLayoutStyle, titleStyle }) => (
  <View style={[styles.titleContainer, titleLayoutStyle]}>
    {titleView || <Text numberOfLines={1} style={[styles.title, titleStyle]}>{title}</Text>
    }
  </View>
)
...
const Header = ({ renderLeftView, title, titleView, titleLayoutStyle, titleStyle, style, goBack, rightButton }) => {
  return (
    <View style={[styles.header, style]}>
      <HeaderLeft renderLeftView={renderLeftView} goBack={goBack}/>
      <HeaderTitle title={title} titleView={titleView} titleLayoutStyle={titleLayoutStyle} titleStyle={titleStyle}/>

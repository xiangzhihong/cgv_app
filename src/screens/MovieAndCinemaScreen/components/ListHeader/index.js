...
import { View, StyleSheet, Text, ScrollView, Text, TouchableOpacity } from 'react-native'
...
const ListHeader = (
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.defaultColor, borderBottomColor: colors.border }]}>

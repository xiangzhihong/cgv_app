...
import {DatePicker} from '../common/Picker';
...
const showDatePicker = (title, onSubmit, subtitle) => {
  global.siblingDatePicker = new RootSiblings(
    <DatePicker title={title} subtitle={subtitle} onSubmit={onSubmit} />,
  );
};
